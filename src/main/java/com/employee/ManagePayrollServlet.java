...
@WebServlet("/ManagePayrollServlet")
public class ManagePayrollServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//fetchPayrollRecords from database using PayrollRecordDBUtil
				...
				RequestDispatcher dis = request.getRequestDispatcher("ManagePayroll.jsp");
