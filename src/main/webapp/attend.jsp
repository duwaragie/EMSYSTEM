   ...
   <div class = "container">
    ...
    <div class="main-content">
        ...
        <div class="search-container">
           <input type="text" id="searchInput" placeholder="Enter Employee ID" onkeyup="Attendance()">
        </div>
     <table id="attendanceTable">
            ...
            <tbody>
                <c:forEach var="atty" items="${attendance}">
                    <tr>
                        <td>${atty.attendanceId}</td>
                        <td>${atty. empId}</td>
                        <td>${atty.date}</td>
                        <td>${atty.status}</td>
                        <td>${atty.checkInTime}</td>
                        <td>${atty.checkOutTime}</td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
