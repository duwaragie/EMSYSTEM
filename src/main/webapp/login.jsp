...
<body>
    ...
    <div class="container">
        <div class="gif-container">
            <img src="${pageContext.request.contextPath}/image/admin2.gif" alt="Animated GIF" class="login-gif" />
        </div>
        <div class="form-container">
            <form action="dash" method="POST" class="form">
                <p id="heading">Welcome, Admin</p>

                <!-- Username Input Field -->
                <div class="field">
                    <i class="fas fa-user input-icon"></i>
                    <input autocomplete="off" placeholder="Username" class="input-field" type="text" name="uid" required>
                </div>

                <!-- Password Input Field -->
                <div class="field">
                    <i class="fas fa-lock input-icon"></i>
                    <input placeholder="Password" class="input-field" type="password" name="pwd" required>
                </div>
